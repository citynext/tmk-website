...
export default function Example() {
    return (
        <section className="flex flex-col items-center gap-24 bg-third p-10">
            <h1 className="uppercase !font-semibold"><strong className="!font-semibold">Prenons le cas de Xavier</strong> qui loue son appartement 200€ la nuit</h1>
            <div className="flex w-full justify-center gap-24 px-24 max-w-[90rem]">
