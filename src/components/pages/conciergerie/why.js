...
export default function Why() {
    return (
        <section className="flex justify-around px-20">
            <Image src="/images/conciergerie/phone.svg" alt='Smartphone TAKE MY KEYS' width={400} height={0} />
                    ...
                    {whys.map((why, index) => (
                        <div key={index} className="flex flex-col items-start mb-10">
                            <div className="flex items-center">
                                ...
                                <h2 className="text-3xl font-medium ml-5">{why.title}</h2>
                            </div>
