...
export default function How() {
    return (
        <section className="p-4 text-center">
            <h1>Que se passe-t-il dans le logement pendant votre absence ?</h1>
            <p className="my-4">Nous procédons à des vérification approfondies des antécédents potentiels et effectuons des contrôles sur les réseaux sociaux au besoin, afin de garantir la sécurité de votre logement.</p>
            <ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-32 p-32">
                {data.map((item, index) => {
